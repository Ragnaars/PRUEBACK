...
public class TrasladoNegocio {
    ...
    public Traslado finalizarTrasladoEscolta(TrasladoFinalizarDTO trasladoFinalizar) throws Exception {
        ...
        traslado.setUsroCompNombre(trasladoFinalizar.getUsroCompNombre());
        ...
        traslado.setReceptorZZNombre(trasladoFinalizar.getReceptorZZNombre());
        ...
        traslado.setCotNombre(trasladoFinalizar.getCotNombre());
        ...
        traslado.setBodegaNombre(trasladoFinalizar.getBodegaNombre());
